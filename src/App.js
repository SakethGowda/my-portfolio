...
import profileImg from './sakethprasadmt.jpeg';
      ...
      <section id="home" className="hero-section">
        <div className="container">
          ...
          <div className="social-links">
            <a href="https://github.com/SakethGowda" className="social-link">
              <Github size={24} />
            </a>
            <a href="https://www.linkedin.com/in/saketh-prasad-mt-613505291" className="social-link">
              <Linkedin size={24} />
            </a>
            <a href="mailto:sakethprasad21@gmail.com" className="social-link">
              <Mail size={24} />
            </a>
          </div>
            ...
            <div>
              ...
              <div className="grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                <div>
                  ...
                  <p style={{ color: '#9ca3af' }}>Srinivas University (8.04/10)cgpa</p>
      ...
      <section id="contact" className="section">
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div className="contact-grid">
            <a 
              href="mailto:sakethprasad21@gmail.com"
            ...
            >
              ...
              <p style={{ color: '#9ca3af', fontSize: '0.875rem' }}>sakethprasad21@gmail.com</p>
            </a>
            
            <a 
              href="tel:+916362179597"
              className="glass-card card"
              style={{ textDecoration: 'none', color: 'inherit', textAlign: 'center' }}
            >
              ...
              <p style={{ color: '#9ca3af', fontSize: '0.875rem' }}>+91 6362179597</p>
            </a>
            ...
            <div className="glass-card card" style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#9ca3af', fontSize: '0.875rem' }}>Chikkamagaluru, Karnataka, India</p>
            </div>
          </div>
          
          <div style={{ display: 'flex', justifyContent: 'center', gap: '25px' }}>
            <a 
              href="https://github.com/SakethGowda"
            ...
            <a 
              href="https://www.linkedin.com/in/saketh-prasad-mt-613505291"
              className="glass-card"
              style={{ padding: '20px', borderRadius: '50%', textDecoration: 'none' }}
            >
      ...
      <footer style={{ padding: '30px 20px', borderTop: '1px solid rgba(255, 255, 255, 0.1)', background: 'rgba(0, 0, 0, 0.2)' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <p style={{ color: '#9ca3af' }}>
            Saketh Prasad MT. Built with React & Custom CSS. (Hire me, and let's grow together.)
          </p>
        </div>
      </footer>
    </div>
